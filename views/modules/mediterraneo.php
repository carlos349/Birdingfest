...
<script type="text/javascript" src="https://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
                      <div style="width:100%" id="carouselExampleIntervala" class="carousel slide mb-5" data-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active" data-interval="10000">
                            <img src="views/images/core-img/mediterranean.jpg" class="d-block w-100" alt="...">
                          </div>
                          <div class="carousel-item" data-interval="2000">
                            <img src="views/images/core-img/cab-1.jpg" class="d-block w-100" alt="...">
                          </div>
                          <div class="carousel-item">
                            <img src="views/images/core-img/cab-2.jpg" class="d-block w-100" alt="...">
                          </div>
            ...
            <center> <br> <br><br>
              ...
              <img id="myImg3" class="mb-3" src="views/images/core-img/c3.jpeg"  style="width:100%;max-width:300px"><br> <br><br>
            </center>
            

            <!-- The Modal -->
            <div id="myModal1" style="z-index: 10;" class="modal1">
              <span class="close1">&times;</span>
              <img class="modal-content1" id="img01">
              
            </div>
            <div id="myModal2" style="z-index: 10;" class="modal1">
              <span class="close1">&times;</span>
              <img class="modal-content1" id="img02">
              
            </div>
            <div id="myModal3" style="z-index: 10;" class="modal1">
              <span class="close1">&times;</span>
    ...
    <div id="programaMobil" class="container"> <h2 class="text-center">Programa</h2> <br><br><br>
      <div class="col-sm-12">
        <center>
      ...
      <div class="swiper-slide-content">
        ...
        <p class="timeline-text text-center"> <span style="font-size:20px">Moderador  <br> <span style="font-weight: 700;">Francesc Kirchner (Delta Birding Fest).</span> </span> <br> 
          ...
          Manuel Menéndez (Bird Ringing Fair)<br>
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide" style="background-image: url('views/images/bg-img/bg-1.jpg')" data-year="Dia 1">
                <div style="width:35%" id="carouselExampleIntervalj" class="carousel slide  ml-5" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active" data-interval="1000">
                        <img src="views/images/core-img/tertulia1.jpg" class="d-block w-100" alt="...">
                      </div>
                    ...
                    <a class="carousel-control-next" href="#carouselExampleIntervalj" role="button" data-slide="next">
                      <span class="carousel-control-next-icon" aria-hidden="true"></span>
                      <span class="sr-only">Next</span>
                    </a>
                  </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="call-to-action-content wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <h3 class="text-center">¡¡UNIDOS POR LA INVESTIGACIÓN Y CONSERVACIÓN DE LA AVIFAUNA EN EL MUNDO!!</h3>
